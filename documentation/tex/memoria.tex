...
\lstdefinelanguage{HTML5}{
	...
	ndkeywords={
		...
		% CSS properties
		width:, max-width:, float:, display:, border:, grid-template-areas:, grid-template-columns:, grid-template-rows:, column-count:, column-gap:, flex-wrap:, justify-content:, align-items:, overflow-x:, overflow-y:, flex-direction:, flex:, max-height:, margin:
	},  
	morecomment=[s]{<!--}{-->},
	tag=[s]
}
...
\begin{document}
	...
	\begin{titlepage}
		...
		\includegraphics[width=0.8\textwidth]{Portada.jpg}\par
		\vspace{2.5cm}
